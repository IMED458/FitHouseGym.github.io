...
თქვენი აბონემენტი წარმატებით გააქტიურდა და ჩვენ მზად ვართ დაგეხმაროთ თქვენი ფიტნეს მიზნების მიღწევაში.
...
ჩვენ ვხელმძღვანელობთ თანამედროვე მიდგომებით და ინდივიდუალური მიდგომით ვუზრუნველყოფთ თითოეულ წევრს.

💪 **რას გთავაზობთ:**
• პროფესიონალური ტრენერები
• თანამედროვე აღჭურვილობა
• მეგობრული და მოტივირებული გარემო
...
მოგვწერეთ ნებისმიერ დროს თუ კითხვა გაქვთ!
...
გელოდებით Fit House Gym-ში!`;
    ...
    window.loadGymClosedTemplate = function() {
      if (document.getElementById('gymClosedTemplate').checked) {
        ...
        document.getElementById('bulkMessage').value = `გაცნობებთ, რომ დღეს ${dateStr} სპორტდარბაზი არ იმუშავებს ტექნიკური შეფერხების გამო.
